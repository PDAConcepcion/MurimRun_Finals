            ...
            <section class="admin-db">
                <div class="d-head">
                    ...
                    <div class="db-buttons">
                        <button id="editBtn" class="btn-5" title="Edit selected row(s)">Edit</button>
                                ...
                                <tr>
                                    <td class="select-cell">
                                        <input type="checkbox" name="selected_deliveries[]"
                                            value="<?= htmlspecialchars($delivery['delivery_id']) ?>">
                                    </td>
                    ...
                    <table id="sectcouriers" cellpadding="2" class="table-area" style="display: none">
                        ...
                        <tbody>
                            <?php foreach ($couriers as $courier): ?>
                                <tr>
                                    <td class="select-cell">
                                        <input type="checkbox" name="selected_couriers[]"
                                            value="<?= htmlspecialchars($courier['courier_id']) ?>">
                                    </td>
